    ...
    <div class="footer">
        <div class="item">
            <div class="about box">
                ...
                <hr />
                <p id="about">
                    CTUT Restaurant là địa điểm ẩm thực hàng đầu cho sinh viên và giảng viên CTUT, là ngôi nhà thứ hai nơi bạn tìm thấy những bữa ăn ngon, chất lượng, giá cả cạnh tranh, không gian thoáng mát rộng rãi và đặc biệt luôn lắng nghe và phục vụ tận tâm.
                </p>
            </div>
            <div class="box instruct">
                ...
                <p class="instruct">Điều khoản dịch vụ.</p>
            </div>
            <div class="box address">
                <h2 id="address">Địa chỉ</h2>
                <hr />
                <p class="ars">256 Đường Nguyễn Văn Cừ nối dài, Quận Ninh Kiều, TP. Cần Thơ</p>
        ...
        <p id="last">
            © 2025 CTUT Restaurant. Món ngon dành cho sinh viên!
        </p>
    </div>
</footer>