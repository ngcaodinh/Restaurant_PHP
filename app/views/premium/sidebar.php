...
/**
 * Template cho Sidebar (thanh điều hướng bên) của trang Premium User
 *
 * Chứa các liên kết đến các trang quản lý chính của premium user (không có quản lý người dùng).
 */
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2 my-2 bg-white" id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand px-4 py-3 m-0" href="<?php echo BASE_URL; ?>premium/dashboard">
            <span class="ms-1 text-sm text-dark font-weight-bolder">CTUT Restaurant Premium</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <!-- Dashboard -->
            <li class="nav-item">
                <a class="nav-link text-dark <?php echo ($current_page == 'dashboard') ? 'active bg-gradient-dark' : ''; ?>" href="<?php echo BASE_URL; ?>premium/dashboard">
            ...
            <!-- Quản lý món ăn -->
            <li class="nav-item">
                <a class="nav-link text-dark <?php echo ($current_page == 'dishes' || $current_page == 'manage_dishes') ? 'active bg-gradient-dark' : ''; ?>" href="<?php echo BASE_URL; ?>premium/dishes">
                    <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <!-- Quản lý đơn hàng -->
            <li class="nav-item">
                <a class="nav-link text-dark <?php echo ($current_page == 'orders') ? 'active bg-gradient-dark' : ''; ?>" href="<?php echo BASE_URL; ?>premium/orders">
                    <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
